...
class Select extends BaseComponent {
  ...
  stateClasses = {
    ...
    isOnTheLeftSide: 'in-on-the-left-side',
    isOnTheRightSide: 'in-on-the-right-side',
  }
  ...
  onKeyDown = (event) => {
    ...
    const action = {
      ArrowDown: this.onArrowKeyDown,
      ArrowUp: this.onArrowKeyUp,
      Space: this.onSpaceKeySpace,
      Enter: this.onEnterKeyEnter,
      Escape: this.onEscapeKeyEscape,
    }[code]
